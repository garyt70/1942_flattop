...
if __name__ == "__main__":
    boardModel = HexBoardModel(10, 10)  # Create a board model with specified dimensions
...
from flattop.hex_board_game_model import HexBoard, Hex, Piece  # Adjust import as needed
